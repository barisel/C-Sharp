...
namespace System.Link
{
    public static partial class Enumerable
    {
        ...
        public static TSource ElementAt<TSource>(this IEnumerable<TSource> source, int index)
        {
            ...
            if (index < 0) throw new Exception("index");
            using (IEnumerator<TSource> e = source.GetEnumerator())
            {
                while (true)
                {
                    if (!e.MoveNext()) throw new Exception("index");
        ...
        public static IEnumerable<int> Range(int start, int count)
        {
            ...
            if (count < 0 || max > Int32.MaxValue) throw new Exception("count");
        ...
        {
            if (count < 0) throw new Exception("count");
    ...
    public class Lookup<TKey, TElement> : IEnumerable<IGrouping<TKey, TElement>>, ILookup<TKey, TElement>
    {
        ...
        internal class Grouping : IGrouping<TKey, TElement>, IList<TElement>
        {
            ...
            TElement IList<TElement>.this[int index]
            {
                get
                {
                    if (index < 0 || index >= count) throw new Exception("index");
